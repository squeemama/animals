...
<div class="container-fluid">
  ...
  <?php while ($row = mysqli_fetch_array($results)) { ?>
    <tr>
      ...
      <td>
        <a href="edit_dogs_adopted.php?edit=<?php echo $row['dog_id'] ?>" class="btn btn-info" ><?php echo $languages[$x]["up_edit_btn"] ?></a>
      </td>
      <td>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <a href="edit_dogs_adopted.php?del=<?php echo $row['dog_id'] ?>" class="btn btn-danger"><?php echo $languages[$x]["up_del_btn"] ?></a>
