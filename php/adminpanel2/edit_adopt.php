  ...
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
		...
		<div class="form-group">
			...
			<input class="form-control " type="text" name="title_sk" value="<?php echo htmlspecialchars($row["adopt_title_sk"]); ?>">
		</div>
		<div class="form-group">
			<label><b><?php echo $languages[$x]["edit_title"] ?> ENG:</b></label>
			<input class="form-control " type="text" name="title_en" value="<?php echo htmlspecialchars($row["adopt_title_en"]); ?>">
		</div>
		<div class="form-group">
			<label><b><?php echo $languages[$x]["edit_title"] ?> DEU:</b></label>
			<input class="form-control " type="text" name="title_de" value="<?php echo htmlspecialchars($row["adopt_title_de"]); ?>">
		</div>
		<div class="form-group">
			<label><b>Text SLO: </b></label>
			<textarea class="form-control" type="text" name="text_sk"  rows="18"><?php echo htmlspecialchars($row["adopt_text_sk"]); ?></textarea>
		</div>
		<div class="form-group">
			<label><b>Text ENG: </b></label>
			<textarea class="form-control" type="text" name="text_en"  rows="18"><?php echo htmlspecialchars($row["adopt_text_en"]); ?></textarea>
		</div> 
		<div class="form-group">
			<label><b>Text DEU: </b></label>
			<textarea class="form-control" type="text" name="text_de"  rows="18"><?php echo htmlspecialchars($row["adopt_text_de"]); ?></textarea>
		</div>           
