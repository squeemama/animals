...
if (isset($_SESSION['userUid']))
  ...
  if (isset($_GET['edit'])) {
    ...
    if (mysqli_num_rows($record) == 1 ) {
      ...
      $height = $n['height'];
      $weight = $n['weight'];
      $cat_desc_sk = $n['cat_desc_sk'];
      $cat_desc_de = $n['cat_desc_de'];
      $cat_desc_en = $n['cat_desc_en'];
      $type_sk = $n['type_sk'];
      $type_en = $n['type_en'];
      $type_de = $n['type_de'];
...
?>
  ...
  <?php while ($row = mysqli_fetch_array($results)) { ?>
    <tr>
      ...
      <td>
        <a href="edit_cats_adopted.php?edit=<?php echo $row['cat_id'] ?>" class="btn btn-info" ><?php echo $languages[$x]["up_edit_btn"] ?></a>
      </td>
      <td>
  ...
  <?php } ?>
    ...
    <div class="inputform">
      <form method="post" action="includes_admin/edit_cats.inc.php" >
        ...
        <div class="input-group form-group">
          <textarea id="textarea_users" class="form-control" type="text" name="cat_desc_sk"><?php echo htmlspecialchars($cat_desc_sk); ?></textarea>
        </div>
        <label class="col"><?php echo $languages[$x]["up_desc"]. " DE" ?>: </label><br>
        <div class="input-group form-group">
          <textarea id="textarea_users" class="form-control" type="text" name="cat_desc_de"><?php echo htmlspecialchars($cat_desc_de); ?></textarea>
        </div>
        <label class="col"><?php echo $languages[$x]["up_desc"]. " EN" ?>: </label><br>
        <div class="input-group form-group">
          <textarea id="textarea_users" class="form-control" type="text" name="cat_desc_en"><?php echo htmlspecialchars($cat_desc_en); ?></textarea>
        </div>
        <div class="input-group form-group">
        ...
        <div class="input-group form-group">
          <label class="col"><?php echo $languages[$x]["up_breed"] ?> ENG: </label>
        ...
        <button class="btn btn-center btn-success" type="submit" name="update"><?php echo $languages[$x]["up_update_btn"] ?></button>
         <button class="btn btn-center btn-warning" type="submit" name="undo"><?php echo $languages[$x]["up_undo_btn"] ?></button>
      </form>
    </div>
  </div>
